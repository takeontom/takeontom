  ...
  return (
    <main>
      ...
      <p>
        ...
        practices regarding your personal data and how we will treat it. We keep
        certain basic information when you visit our website and recognise the
        importance of keeping that information secure and letting you know what
        we will do with it.
      </p>
      <p>
        For the purpose of the Data Protection Act 1998 (the Act), the data
        controller is Take on Tom Ltd of Bank Gallery, High Street, Kenilworth,
        Warwickshire, United Kingdom, CV8 1LY (registration number 10522058).
      </p>
      <p>
      ...
      <p>
        Information that you provide by filling in forms on the Take on Tom
        website, http://www.takeontom.com (our site). This includes information
      ...
      <ul>
        ...
        <li>
          ...
          customiseour site according to your individual interests.
        </li>
      ...
      <p>
        ...
        your progress through our website, collecting anonymous data on where
        you have come from, which pages you visit, and how long you spend on the
        site. This data is then stored by Google in order to create reports.
      ...
      <p>
        ...
        website activity for us and providing other services relating to website
        ...
        associate your IP address with any other data held by Google. By using
      ...
      <p>
        ...
        copy of Google&apos;s privacy policy.
      </p>
      <h2>Where we store your personal data</h2>
      <p>
        The data that we collect from you may be transferred to, and stored at,
        a destination outside the European Economic Area (&quot;EEA&quot;). It
        may also be processed by staff operating outside the EEA who work for us
      ...
      <ul>
        ...
        <li>
          ...
          order to comply with any legal obligation, our customers, or others.
      ...
      <p>
        ...
        welcomed and should be made via the contact us page.
      </p>
    </main>
  );
}
